...
<script>
    import VueBarcode from 'vue-barcode';//despues de instalar npm 
    export default {
        data (){
            return {
                articulo_id: 0,
        ...
        components:{
            'barcode':VueBarcode //para utilizar nuestro componente en el html inicia linea 170 (import VueBarcode from 'vue-barcode')
        },   
        computed:{
            isActived: function(){
        ...
        methods : {
            ...
            desactivarArticulo(id){
               ...
               activarArticulo(id){
                ...
                swalWithBootstrapButtons.fire({
                title: 'Esta seguro de ACTIVAR esta el Artículo?',
                text: "Consulta!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Aceptar',
            ...
            validarArticulo(){
                ...
                if (this.idcategoria==0) this.errorMostrarMsjArticulo.push("Seleccionar una Categoria");
                ...
                if (!this.precio_venta) this.errorMostrarMsjArticulo.push("El Precio de Articulo no puede estar vacío.");
